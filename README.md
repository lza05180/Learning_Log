...
채윤이의 수업 일정을 달력으로 보여주고, 선생님이 비밀번호로 로그인하여 수업 기록을 추가·수정·삭제할 수 있는 웹사이트입니다. 이 폴더는 ChatGPT Sites 전용 기능을 사용하지 않는 일반적인 **Next.js + PostgreSQL** 프로젝트이므로 Vercel에서 실행할 수 있습니다.
...
- 기존 ChatGPT Sites 기록을 자동으로 백업하고 옮기는 스크립트 포함
